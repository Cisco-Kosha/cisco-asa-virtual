...
import (
	"encoding/json"
	"github.com/kosha/cisco-asa-virtual/pkg/httpclient"
...
func (a *App) commonMiddleware(log logger.Logger) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		res, statusCode, err := httpclient.MakeHttpBasicAuthCall(headers, username, password, method, url, c, log, a.Cfg.IsSecure())
		if err != nil {
